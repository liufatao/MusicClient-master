...
public class ModelAdapter extends RecyclerView.Adapter<ModelAdapter.ViewHolder> {
    ...
    public ModelAdapter(Context context,List<Music> musicList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ModelAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_mode_music, parent, false));
    }
