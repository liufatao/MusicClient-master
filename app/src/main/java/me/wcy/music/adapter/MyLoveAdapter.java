...
public class MyLoveAdapter extends RecyclerView.Adapter<MyLoveAdapter.ViewHolder> {
    private List<LoveMusic> musicList;
    private Context context;
    private OnItemClickListener onItemClickListener;
    private OnMoreClickListener onMoreClickListener;
    public MyLoveAdapter(Context context, List<LoveMusic> musicList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyLoveAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_latest_music, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        LoveMusic music = musicList.get(position);
