...
import me.wcy.music.model.ThemeInfo;
import me.wcy.music.utils.MusicUtils;

public class ThemeActivity extends BaseActivity {
    public static int THEME_SIZE = 11;
    private String[] themeType = {"网易红", "知乎蓝", "酷安绿", "哔哩粉", "藤萝紫", "碧海蓝", "樱草绿", "咖啡棕", "柠檬橙", "星空灰", "夜间模式"};
    private int[] colors = {R.color.cloudRed, R.color.zhihuBlue, R.color.kuanGreen, R.color.biliPink,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectTheme = MusicUtils.getTheme(ThemeActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(ThemeActivity.this, MusicActivity.class);
...
//                overridePendingTransition(R.anim.in_from_left_anim,R.anim.out_to_right_anim);
    ...
    private class ThemeAdapter extends RecyclerView.Adapter<ThemeAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, final int position) {
            ...
            if (themeInfo.isSelect()) {
                holder.circleIv.setImageResource(R.drawable.ic_tick);
    ...
    private void refreshTheme(ThemeInfo themeInfo, int position) {
        if (position == (THEME_SIZE - 1)) {
            MusicUtils.setNightMode(ThemeActivity.this, true);
        } else if (MusicUtils.getNightMode(ThemeActivity.this)) {
            MusicUtils.setNightMode(ThemeActivity.this, false);
        }
        selectTheme = position;
        MusicUtils.setTheme(ThemeActivity.this, position);
