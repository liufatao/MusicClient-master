...
public class AudioPlayer {
    ...
    public void init(Context context) {
        ...
        musicList = musicDaoUtils.queryOrderAscMusic();
    ...
    public void addAndPlay(Music music) {
        ...
        if (position < 0) {
            musicList.add(music);
            musicDaoUtils.insertMusic(music);
    ...
    public void play(int position) {
        ...
        } else if (position >= musicSize) {
            position = 0;
        }

        setPlayPosition(position);
        setPlaySongId(musicList.get(position).getSongId());
    ...
    public void delete(int position) {
        ...
        musicDaoUtils.deleteMusic(position);
    ...
    public Long getPlaySongID() {
        long musicId = Preferences.getPlaySongId();
        if (musicId < 0) {
            musicId = 0;
            Preferences.savePlaySongId(musicId);
        }
        return musicId;
    }
    private void setPlaySongId(Long musicID) {
        Preferences.savePlaySongId(musicID);
    }
}
